...
function getLabels(method) {
    //if value of requestStream & responseStream is true, it's a bidirectional stream
    //if requestStream is true but not responseStream, it's client stream
    //if requestStream is false but responseStream is true, it's a server stream
    //else unary
