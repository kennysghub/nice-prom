...
var request = { Hello: 'hi' };
var clientRequest = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.greetings(request)];
            case 1:
                response = _a.sent();
...
clientRequest();
registry_2.mergedRegistry.metrics().then(function (data) { return console.log("merged: ", data); });
registry_1.default.metrics().then(function (data) { return console.log("global: ", data); });
registry_3.default.metrics().then(function (data) { return console.log(data); });
